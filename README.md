...
To trigger the animation, you need to use a ref to call the start function of this component. Pass a callback to the start function to change the scen before the circle is hidden(check out usage exemple handle press function). 
